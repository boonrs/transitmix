...
app.BlurredSidebarView = Backbone.View.extend({
  template: _.template($('#tmpl-blurred-sidebar-view').html()),
  lineTemplate: _.template($('#tmpl-blurred-sidebar-line-view').html()),
