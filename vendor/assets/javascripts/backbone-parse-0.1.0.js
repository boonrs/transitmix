...
var application_id = "4PnUsBogAPmJDpQBUHUxzis0VCVbJrGGdOzm4Q2t";
var rest_api_key = "hXsfKzrl6M0CT7hzfP19xGnomJaEQqq20yoIjW0s";
var api_version = "1";
	...
	Backbone.sync = function(method, model, options) {
	    ...
	    if (!options.data && model && (method == 'create' || method == 'update')) {
	      data = JSON.stringify(model.toJSON());
            ...
            if (options.query.limit) data = "limit=" + options.query.limit + '&order=-updatedAt';
